    ...
    <>
      <header>
        ...
        <div className="flex flex-wrap justify-between items-center py-4 px-4  max-w-[1320px] mx-auto">
          {/* Logo */}
          <div
            className={`${lily.className} text-2xl font-bold text-green-800`}
          >
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative inline-block text-left" ref={dropdownRef}>
              <div
                ...
                className="text-base cursor-pointer px-3 py-2  rounded-md bg-white  hover:bg-gray-100"
              >
                {selectedLang} ▾
              </div>

              {isOpen && (
                <div className="absolute z-10 mt-1 w-28 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
            ...
            <span className="text-[#007ADF] text-sm leading-6 font-semibold cursor-pointer hidden sm:inline">
              Gift Card
            </span>
